...
function CountDownObject() {
    ...
    function DrawText() {
        ...
        if (num == 1) {
            CanvasContext.fillText("СЕКУНД", param.sec1Position + 80 * 0.5 * param.elementSize, 150 * param.elementSize);
        } else {
            CanvasContext.fillText("СЕКУНД", param.sec1Position - 80 * 0.05 * param.elementSize, 150 * param.elementSize);
        }
        if (num == 3) {
            CanvasContext.fillText("МИНУТ", param.min1Position + 80 * 0.5 * param.elementSize, 150 * param.elementSize);
        } else if (num > 3) {
            CanvasContext.fillText("МИНУТ", param.min1Position - 80 * 0.05 * param.elementSize, 150 * param.elementSize);
        }
        if (num == 5) {
            CanvasContext.fillText("ЧАСОВ", param.hour1Position + 80 * 0.5 * param.elementSize, 150 * param.elementSize);
        } else if (num > 5) {
            CanvasContext.fillText("ЧАСОВ", param.hour1Position - 80 * 0.05 * param.elementSize, 150 * param.elementSize);
        }
        if (num == 7) {
            CanvasContext.fillText("ДНЕЙ", param.day1Position + 80 * 0.5 * param.elementSize, 150 * param.elementSize);
        } else if (num == 8) {
            CanvasContext.fillText("ДНЕЙ", param.day1Position - 80 * 0.05 * param.elementSize, 150 * param.elementSize);
        } else {
            CanvasContext.fillText("ДНЕЙ", param.day1Position - 80 * 0.6 * param.elementSize, 150 * param.elementSize);
        }
    }
